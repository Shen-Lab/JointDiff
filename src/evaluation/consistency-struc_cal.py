...
from utils_eval import dict_save, TMscore_cal_tmtool #TM_score, TM_score_asym
### for frozen cases
import signal
    ...
    for sample in sample_dict:
        ...
        for pred in sample_dict[sample]:
            ...
            try:
                ...
                # TMalign can be unavailable
                tms, rmsd = TMscore_cal_tmtool(pred_pdb, ref_pdb, with_RMSD = True) 
