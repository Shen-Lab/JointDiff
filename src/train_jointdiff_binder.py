...
def train(
    ...
    if 'mask_gen' not in batch:
        batch['mask_gen'] = batch['mask']
    if 'res_nb' not in batch:
        batch['res_nb'] = batch['resi_nb']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pdb_dir', type=str,
        default='../data/ProteinMPNN/pdb_2021aug02/pdb/'
    )
    parser.add_argument('--processed_dir', type=str,
        default='../data/ProteinMPNN/'
    )
    parser.add_argument('--interface_path', type=str,
        default='../data/ProteinMPNN/interface_dict_all.pt'
    )
