...
PRETRAINED_PATH = '../../Pretrained/'  # path to save the downloaded models; added by SZ
...
def load_hub_workaround(url, model_dir = PRETRAINED_PATH):  # by SZ
    try:
        ## data = torch.hub.load_state_dict_from_url(url, progress=False, map_location="cpu")
        data = torch.hub.load_state_dict_from_url(url, progress=False, map_location="cpu", model_dir = model_dir)  # by SZ
    except RuntimeError:
